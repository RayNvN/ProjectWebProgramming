<x-guest-layout>
    <div class="mb-6 text-center">
        <h2 class="text-xl font-bold text-slate-900 dark:text-white">Choose New Password</h2>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Please enter your new security credentials</p>
    </div>
